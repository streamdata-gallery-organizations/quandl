...
- name: Quandl API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/quandl/master/_listings/quandl/datasets-database-code-dataset-code-metadata-get.md
x-common:
